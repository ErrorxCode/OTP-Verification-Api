...
public class EmailVerification {
    ...
    private static boolean isTempMail(String mail,int server){
        String [] real = {"1033edge.com" ,
                "11mail.com" ,
                "123.com" ,
                "123box.net" ,
                "123india.com" ,
                ...
                "zzn.com" ,
                "zzom.co.uk"};
        String [] temp = {"0815.ru" ,"biyac.com","shzsedu.com",
                "0wnd.net" ,
                "0wnd.org" ,
                "10minutemail.co.za" ,
                "10minutemail.com" ,
        ...
        ArrayList<String> real_domains = new ArrayList<String>(Arrays.asList(real));
        String end = mail.split("@")[1];
        return !real_domains.contains(end) && server == SERVER_ALTERNATIVE;
    }
}
